  ...
  try {
    res = await fetch("https://api.groq.com/openai/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [{
          role: "user",
          content: `Generate ${count} frequently asked questions and answers for a product called "${title}".
...
export default function Index() {
  ...
  return (
    <div style={{ maxWidth: 740, margin: "0 auto", padding: "2rem 1rem", fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }}>
          <div>
            ...
            <select
              ...
              style={{ width: "100%", padding: "0.65rem", border: "1.5px solid #e5e7eb", borderRadius: 8, fontSize: "0.9rem", background: "#f9fafb", cursor: "pointer" }}
            >
        ...
        <fetcher.Form method="post" style={{ marginBottom: "1rem" }}>
          ...
          <button
            ...
            style={{
              width: "100%",
              padding: "1rem",
              background: isLoading ? "#a5b4fc" : `linear-gradient(135deg, ${ACCENT}, #8b5cf6)`,
              color: "#fff",
              border: "none",
              borderRadius: 14,
              fontSize: "1rem",
          ...
          >
            {isLoading ? "✨ Generating FAQs..." : `✨ Generate & Save ${count} FAQs`}
          </button>
        </fetcher.Form>
      )}
      ...
      {editableFaqs && editableFaqs.length > 0 && selected && (
        <div style={card}>
          ...
          {editableFaqs.map((faq, i) => (
            <div key={i} style={{ border: `1.5px solid ${ACCENT}33`, borderRadius: 10, marginBottom: "0.6rem", overflow: "hidden" }}>
              {editMode ? (
      ...
      {/* Review Section */}
      <div style={{ background: "linear-gradient(135deg, #eef2ff, #faf5ff)", border: "1px solid #e0e7ff", borderRadius: 16, padding: "1.75rem", textAlign: "center" }}>
        ...
        <button
          ...
          style={{ padding: "0.7rem 1.6rem", background: ACCENT, color: "#fff", borderRadius: 10, fontSize: "0.9rem", fontWeight: 700, border: "none", cursor: "pointer", boxShadow: "0 4px 12px rgba(99,102,241,0.3)" }}
        >
          ⭐ Leave a Review
        </button>
      </div>
